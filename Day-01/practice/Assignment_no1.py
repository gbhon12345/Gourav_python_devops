...
def memory_health_check():
    ...
    if Memory_Threshold < Current_mem_percent:
        print(f"Current Memory usage {Current_mem_percent} more than Threshold {Memory_Threshold} ")
        print("Alert Notification has been sent to the System team and Operation team")
    else:
        print(f"Memory utilization {Current_mem_percent} is Safe.")
